...
Why Quarantine?
---------------
The original system created a new prototype IMMEDIATELY whenever a behavioral
vector's similarity to all existing prototypes fell below 0.8. This is a
critical security vulnerability and a correctness flaw:
  ...
  set. Subsequent attacks that match this injected prototype would pass
  authentication.
